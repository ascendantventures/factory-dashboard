// tests/e2e/webhooks/webhooks-authenticated.spec.ts
// Issue #90 — Verify authenticated users can access webhooks page without server exception
...
test.describe('Webhooks page — authenticated user', () => {
  ...
  test('renders webhooks page without server exception', async ({ page }) => {
    ...
    expect(content).not.toContain('Application error: a server-side exception has occurred')
  })
